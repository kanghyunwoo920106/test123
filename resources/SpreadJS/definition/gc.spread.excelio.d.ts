    ...
    module Spread{
        module Excel{
            ...
            export class IO{
                 ...
                 * @param {GC.Spread.Excel.IO.OpenOptions} openOptions The options for import excel.
                 * @returns {void}
                 * @example
                 * ```
                 ...
                 * @param {function} errorCallBack Call this function if an error occurs. The exception parameter object structure `{ errorCode: GC.Spread.Excel.IO.ErrorCode, errorMessage: string}`.
                 * @param {GC.Spread.Excel.IO.SaveOptions} saveOptions The options for export excel.
                 * @returns {void}
                 * @example
                 * ```
                 * var workbook = new GC.Spread.Sheets.Workbook(document.getElementById("ss"));
